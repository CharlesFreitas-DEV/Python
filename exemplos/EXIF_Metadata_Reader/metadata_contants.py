...
# --------------------------------------------------------------------------------
# Diretorios da aplicação e das imagens
DIR_APP    = os.path.dirname(__file__)
DIR_IMG    = os.path.join(DIR_APP, "images")

# Página de Código para Decodificação dos Metadados (ASCII)
CODE_PAGE  = 'utf-8'  

# --------------------------------------------------------------------------------
# Cabecalho do arquivo JPG
JPG_HEADER = b'\xFF\xD8'

# Cabecalho do EXIF
EXIF_HEADER = b'\xFF\xE1'


# --------------------------------------------------------------------------------
# Listas com os nomes dos campos dos dicionários
HEADER_EXIF     = [  'exifSize', 'exifMarker', 'temp1', 'tiffHeader', 
                     'temp2', 'temp3', 'metaCount' ]

HEADER_METADATA = [  'TAGNumber', 'DataFormat', 'NumberComponents', 'DataValue'  ]

HEADER_GPS      = [  'TAGNumber', 'DataFormat', 'NumberComponents', 'DataValue'  ]
